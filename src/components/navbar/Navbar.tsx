...
const Navbar = ({ data, categories }: { data: HeaderType, categories: Category[] }) => {
    ...
    return <>
        <nav className='sticky top-0 z-50 bg-white dark:bg-black'>
            <div className='py-4 flex items-center justify-between gap-2 container'>
                <Logo />
                {/* Delivery */}
                ...
                <Link href={'/orders'} className='w-fit'>
                    <span className='text-sm'>Return <br /></span>
                    <span>& Orders</span>
                </Link>
                {/* Sign in and Register */}
                <div className='flex items-center gap-1 flex-1 max-w-[100px] w-full justify-between'>
